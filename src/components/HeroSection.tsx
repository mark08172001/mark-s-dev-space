...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <div className="z-20 max-lg:relative max-lg:h-[460px] sm:max-lg:h-[520px] max-lg:w-full max-lg:basis-full max-lg:shrink-0 lg:absolute lg:inset-0 lg:pointer-events-none">
